...
/**
  ...
  */
  ...
  /**
      @brief Comprueba que un número no es cero. Se utiliza antes de de crear un racional para evitar que el denominador se anule.
      @param den número a comprobar
    */
  void comprueba_denominador_nulo( int den );
